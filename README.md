# Apex Auditor is a program designed to extract, directly from video imaging, the signal amplitudes and analyse peak intervals from live heart tissue. Only pixels with organised activity are included.
